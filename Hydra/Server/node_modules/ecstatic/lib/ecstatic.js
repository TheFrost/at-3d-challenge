...
var ecstatic = module.exports = function (dir, options) {
  ...
  return function middleware (req, res, next) {
    ...
    options.onRequest && options.onRequest(req.url.toLowerCase(), res, req);
    ...
    function serve(stat) {
      ...
      stat = options.onServe && options.onServe(file.toLowerCase()) || stat;
      ...
      if (contentType) {
        ...
        if (charSet) {
          ...
          if (!contentType.includes('audio')) contentType += '; charset=' + charSet;
        }
      }
