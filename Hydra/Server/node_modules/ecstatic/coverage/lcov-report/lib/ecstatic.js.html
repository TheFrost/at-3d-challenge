...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> ecstatic.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  if (opts.mimeTypes) {
    ...
    else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof opts.mimeTypes === 'object') {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (req.method === 'OPTIONS' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >handleOptionsMethod)</span> {
<span class="cstat-no" title="statement not covered" >      return res.end();</span>
    }
&nbsp;
    // TODO: This check is broken, which causes the 403 on the
    // expected 404.
    <span class="missing-if-branch" title="if path not taken" >I</span>if (file.slice(0, root.length) !== root) {
<span class="cstat-no" title="statement not covered" >      return status[403](res, next);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (req.method &amp;&amp; (req.method !== 'GET' &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >req.method !== 'HEAD' </span>)) {
<span class="cstat-no" title="statement not covered" >      return status[405](res, next);</span>
    }
&nbsp;
    function statFile() {
      fs.stat(file, function (err, stat) {
        ...
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >          status[500](res, next, { error: err });</span>
        }
...
<span class="cstat-no" title="statement not covered" >                return status[500](res, next, { error: err });</span>
              }
              <span class="missing-if-branch" title="else path not taken" >E</span>if (opts.showDir) {
...
&nbsp;
    ...
    if (opts.gzip &amp;&amp; shouldCompress(req)) {
      fs.stat(gzipped, function (err, stat) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!err &amp;&amp; stat.isFile()) {
          file = gzipped;
          return serve(stat);
        } else {
<span class="cstat-no" title="statement not covered" >          statFile();</span>
        }
      });
    } else {
      statFile();
...
&nbsp;
    function serve(stat) {
      ...
      // special case.
      var defaultType = opts.contentType || <span class="branch-1 cbranch-no" title="branch not covered" >'application/octet-stream',</span>
          contentType = mime.lookup(file, defaultType),
          charSet;
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (contentType) {
        charSet = mime.charsets.lookup(contentType, 'utf-8');
        <span class="missing-if-branch" title="else path not taken" >E</span>if (charSet) {
...
&nbsp;
      ...
      if (range) {
        ...
        fstream.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >          status['500'](res, next, { error: err });</span>
        });
        res.on('close', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >           fstream.destroy();</span>
        });
        res.writeHead(206, {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (req.method === "HEAD") {
<span class="cstat-no" title="statement not covered" >        return res.end();</span>
      }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (clientModifiedSince) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (clientModifiedDate.toString() === 'Invalid Date') {
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
        // If the client's copy is older than the server's, don't return 304
        <span class="missing-if-branch" title="if path not taken" >I</span>if (clientModifiedDate &lt; new Date(serverLastModified)) {
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
      }
&nbsp;
      if (clientEtag) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.weakCompare &amp;&amp; clientEtag !== serverEtag
          &amp;&amp; clientEtag !== ('W/' + serverEtag) &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >('W/' + clientEtag) !== serverEtag)</span> {
<span class="cstat-no" title="statement not covered" >          return false;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (process.platform === 'win32' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >/\\/.test(piece))</span> {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid forward slash character');</span>
    }
&nbsp;
    return piece;
  }).join('/');
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.help || opts.h) {
<span class="cstat-no" title="statement not covered" >    var u = console.error;</span>
<span class="cstat-no" title="statement not covered" >    u('usage: ecstatic [dir] {options} --port PORT');</span>
<span class="cstat-no" title="statement not covered" >    u('see https://npm.im/ecstatic for more docs');</span>
