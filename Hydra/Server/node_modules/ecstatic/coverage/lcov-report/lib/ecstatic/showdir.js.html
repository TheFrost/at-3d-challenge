...
<html lang="en">
<head>
    <title>Code coverage report for lib/ecstatic/showdir.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/ecstatic/</a> showdir.js
    </h1>
    <div class='clearfix'>
...
223
224
225</td><td class="line-coverage quiet"><span class="cline-any cline-yes">35×</span>
...
<span class="cstat-no" title="statement not covered" >        return handleError ? status[500](res, next, { error: err }) : next();</span>
      }
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!showDotfiles) {
...
<span class="cstat-no" title="statement not covered" >            return filename.slice(0,1) !== '.';</span>
          });
        }
&nbsp;
...
&nbsp;
          paths.forEach(function (file) {
            fs.stat(path.join(dir, file), function (err, s) {
              <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >                errs.push([file, err]);</span>
              }
...
&nbsp;
          ...
          lolwuts.sort(<span class="fstat-no" title="function not covered" >function (a, b) {</span> <span class="cstat-no" title="statement not covered" >return a[0].toString().localeCompare(b[0].toString()); </span>}).forEach(writeRow);
&nbsp;
          html += '&lt;/table&gt;\n';
          html += '&lt;br&gt;&lt;address&gt;Node.js ' +
            ...
            'server running @ ' +
            he.encode(req.headers.host || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> + '&lt;/address&gt;\n' +
            '&lt;/body&gt;&lt;/html&gt;'
          ;
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!failed) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!stat.isDirectory || !stat.mode) {
...
&nbsp;
    var sizeString = '';
    var bytes = stat.size;
    var threshold = si ? <span class="branch-0 cbranch-no" title="branch not covered" >1000 </span>: 1024;
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(b)) <span class="cstat-no" title="statement not covered" >b = '??';</span>
&nbsp;
    return b + units[u];
}
&nbsp;</pre></td></tr>
