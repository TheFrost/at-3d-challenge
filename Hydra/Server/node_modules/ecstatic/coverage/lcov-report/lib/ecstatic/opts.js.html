...
<html lang="en">
<head>
    <title>Code coverage report for lib/ecstatic/opts.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/ecstatic/</a> opts.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// This is so you can have options aliasing and defaults in one place.
&nbsp;
...
&nbsp;
    if (typeof opts.cache !== 'undefined' &amp;&amp; opts.cache !== null) {
      ...
      else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof opts.cache === 'function') {
        cache = opts.cache
      }
    }
&nbsp;
...
&nbsp;
      function setHeader (str) {
        var m = /^(.+?)\s*:\s*(.*)$/.exec(str)
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!m) <span class="cstat-no" title="statement not covered" >headers[str] = true</span>
...
&nbsp;
    aliases.handleOptionsMethod.some(function (k) {
      if (isDeclared(k)) {
        handleOptionsMethod = handleOptionsMethod || <span class="branch-1 cbranch-no" title="branch not covered" >opts[k];</span>
        return true;
      }
    });
  }
